...
const boxAlphaMap = textureLoader.load("./texture/16.jpg");

let boxGeometry = new THREE.BoxGeometry(1, 1, 1);
const material3 = new THREE.MeshPhysicalMaterial({
  color: 0xffcccc,
  alphaMap: boxAlphaMap,
  transparent: true,
  side: THREE.DoubleSide,
  alphaTest: 0.5, // 透明贴图要加这个
  shadowSide: THREE.BackSide // 背面投射阴影
});
...
pointLight.shadow.mapSize.width = 2045;
pointLight.shadow.mapSize.height = 2045;
